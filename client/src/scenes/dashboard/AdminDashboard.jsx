...
import { ShoppingCart, People, AttachMoney, TrendingUp, AdminPanelSettings } from '@mui/icons-material';
...
const statData = [
  ...
  { title: 'Admins', value: '12', increase: '+2%', icon: <AdminPanelSettings />, color: '#f43f5e' },
];
  ...
  return (
    <Box p={{ xs: 3, md: 4 }}>
      <Box mb={4}>
        ...
        <Typography variant="body1" color="text.secondary">Manage your platform with powerful insights.</Typography>
      </Box>
      ...
      <Box sx={{
        ...
        <Typography variant="h6" fontWeight={700} mb={3}>User Management</Typography>
        <Box height={{ xs: 350, md: 450 }}>
          <DataGrid
            rows={userRows}
            columns={userColumns}
            pageSize={5}
            ...
            sx={{
              border: 'none',
              '& .MuiDataGrid-cell': { borderColor: 'rgba(148, 163, 184, 0.1)' },
              '& .MuiDataGrid-columnHeaders': { 
                backgroundColor: 'rgba(99, 102, 241, 0.1)',
                borderColor: 'rgba(148, 163, 184, 0.1)',
                fontWeight: 700,
              },
              '& .MuiDataGrid-row:hover': { backgroundColor: 'rgba(99, 102, 241, 0.05)' },
            }}
          />
        </Box>
      </Box>
